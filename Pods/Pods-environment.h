...
// OCPrayerTimes
#define COCOAPODS_POD_AVAILABLE_OCPrayerTimes
#define COCOAPODS_VERSION_MAJOR_OCPrayerTimes 0
#define COCOAPODS_VERSION_MINOR_OCPrayerTimes 1
#define COCOAPODS_VERSION_PATCH_OCPrayerTimes 0
